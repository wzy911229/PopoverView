...
//  Copyright © 2015年 ZYdata. All rights reserved.
//

#import "ZYPopoverAnimtor.h"
#import "ZYPopoverPresentationController.h"

@interface ZYPopoverAnimtor ()
@property(nonatomic,assign)bool isPresent;
@end

@implementation ZYPopoverAnimtor
...
- (UIPresentationController *)presentationControllerForPresentedViewController:(UIViewController *)presented presentingViewController:(UIViewController *)presenting sourceViewController:(UIViewController *)source
{
    ...
    ZYPopoverPresentationController *popVc = [[ZYPopoverPresentationController alloc]initWithPresentedViewController:presented presentingViewController:presenting];
...
{
    [[NSNotificationCenter defaultCenter] postNotificationName:ZYPopoverAnimatorDidShow object:self];
    self.isPresent =YES;
    return self;
}
/**
...
{
    [[NSNotificationCenter defaultCenter] postNotificationName:ZYPopoverAnimatorDidDismiss object:self];
    self.isPresent =NO;
    return self;
}
